...
<div style="max-width: 800px; margin: 2rem auto; text-align: center; padding: 0 1.5rem;">
  <img :src="withBase('/images/oli_1.jpg')" alt="Олімпіада з 3D-моделювання" style="width: 100%; border-radius: 12px; box-shadow: 0 4px 20px rgba(0,0,0,0.12); margin-bottom: 1.5rem;" />
  <h2 style="color: #2c3e40; margin-bottom: 0.75rem;">🏆 Олімпіада з 3D-моделювання</h2>
  <p style="font-size: 1.1rem; line-height: 1.8; color: #5a6b6e;">
